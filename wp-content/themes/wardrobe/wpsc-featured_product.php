        ...
        <div class="featured_product_display">
            <div class="featured_product_display_item product_view_<?php $product->ID; ?>">
                ...
                <div class="item_text">
                    <h2><a href='<?php echo get_permalink( $product->ID ); ?>'><?php echo get_the_title( $product->ID ); ?></a></h2>
                      <div class="pricedisplay featured_product_price">
                        <?php _e("Price","colabsthemes"); ?>: <?php echo wpsc_the_product_price(); ?>
                    </div>
                    
                    <div class='wpsc_description'>
                        <?php echo wpsc_the_product_description(); ?> <a href='<?php echo get_permalink( $product->ID ); ?>'><?php _e("More Information","colabsthemes"); ?>&hellip;</a>
                    </div>
                ...
                <div class="item_no_image">
                    <a href="<?php echo get_the_title( $product->ID ); ?>"><span><?php _e("No Image Available","colabsthemes"); ?></span></a>
                </div><?php endif; ?>
            </div>
            <div class="clear"></div>
        </div>
