	...
	<div class="product_grid_display group">
		<?php while (wpsc_have_products()) :  wpsc_the_product(); ?>
			<div class="product_grid_item product_view_<?php echo wpsc_the_product_id(); ?>">
				...
				<?php if(wpsc_product_on_special()) : ?><span class="sale"><?php _e('Sale', 'colabsthemes'); ?></span><?php endif; ?>	
					...
					<div class="grid_product_info">
						...
						<?php endif; ?>
							...
							<?php if(wpsc_product_on_special()) : ?>
										<p class="pricedisplay <?php echo wpsc_the_product_id(); ?>"><?php _e('Old Price', 'colabsthemes'); ?>:<span class="oldprice"><?php echo wpsc_product_normal_price(); ?></span></p>
									<?php endif; ?>
						...
						<?php if(get_option('display_moredetails') == 1) : ?>
							<a href="<?php echo wpsc_the_product_permalink(); ?>" class="more_details"><?php _e("More Details","colabsthemes"); ?></a>
						<?php endif; ?> 
					...
					<div class="grid_more_info">
						...
						<div class="wpsc_variation_forms">
							...
							<?php if((get_option('display_addtocart') == 1) && (get_option('addtocart_or_buynow') !='1')) :?> 	   
								...
								<?php else : ?>
									<p class="soldout"><?php _e('Sorry, sold out!', 'colabsthemes'); ?></p>
								<?php endif ; ?>
							<?php endif; ?>
		...
		<?php if(wpsc_product_count() == 0):?>
			<p><?php  _e('There are no products in this group.', 'colabsthemes'); ?></p>
		<?php endif ; ?>
